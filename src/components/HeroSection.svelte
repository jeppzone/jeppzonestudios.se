<section
	id="about"
	class="min-h-[88vh] flex flex-col justify-center pt-24 pb-16 px-2 sm:px-0"
	aria-labelledby="hero-title"
>
	<div class="max-w-3xl">
		<h1
			id="hero-title"
			class="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight text-white leading-[1.05] mb-8"
		>
